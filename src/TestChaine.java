...
public class TestChaine extends TestCase
{
	/**/
	@Test
	...
	{
		ChaineDeCaractere o1;
		ChaineDeCaractere o2;
		String str1;
		String str2;
		ChaineDeCaractere res;

		str1 = "ABC";
		str2 = "123";

		o1 = new ChaineDeCaractere(str1);
		o2 = new ChaineDeCaractere(str2);
	...
	public void testSize()
	{
		...
		obj = new ChaineDeCaractere(chars);
		objSize = obj.size();
	...
	public void testSubchaine()
	{
		String str;
		ChaineDeCaractere obj;
		ChaineDeCaractere sub;
		int index;
		int length;

		//ChaineDeCaractere subChaine(int index, int length)
